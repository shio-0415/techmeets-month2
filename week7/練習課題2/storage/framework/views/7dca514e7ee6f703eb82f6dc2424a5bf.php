<?php $__env->startSection('title', '予約作成'); ?>

<?php $__env->startSection('content'); ?>
    <h1><?php echo e($event->title); ?> の予約</h1>
...
unset($__errorArgs, $__bag); ?>
        ...
        <label>人数</label>
        <input type="number" name="number_of_people" min="1" value="<?php echo e(old('number_of_people', 1)); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <label>予約日時</label>
        <input type="datetime-local" name="reserved_at" value="<?php echo e(old('reserved_at')); ?>">
