        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="<?php echo e(route('posts.store')); ?>" method="POST">
                    ...
                    <input type="text" name="title" value="<?php echo e(old('title')); ?>" class="border rounded w-full p-2 mb-1">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <textarea name="content" rows="6" class="border rounded w-full p-2 mb-1"><?php echo e(old('content')); ?></textarea>
